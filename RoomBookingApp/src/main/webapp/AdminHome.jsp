...
<body>
	<nav>
		...
		<ul class="topnav" id="dropdownclick">
			...
			<li class="topnav-right"><a href="Booking.jsp">Bookings</a></li>
		</ul>
	</nav>
...
<a href="AdminBookRoom.jsp"><button>Book</button></a>
	...
	<div class="column" style="background-color: black; text-align: left">
		<ul style="color: white; text-align: left; line-height: 2.2;">
			...
			<h4 style="margin: 0%; font-weight: normal">Mail.-  Rajhotel@gmail.com</h4>
		</ul>
